      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center gap-4 mb-2">
            <span className="font-heading text-3xl text-foreground">{product.price.toLocaleString("ru-RU")} ₽</span>
          </div>
          <p className="text-sm text-muted-foreground font-body mb-8">{product.roses} роз в букете</p>
          <button
            onClick={() => addToCart(product)}
            className="inline-flex items-center justify-center gap-3 bg-primary text-primary-foreground font-body text-sm tracking-wider uppercase px-8 py-4 rounded-lg hover:bg-rose-dark transition-colors w-full sm:w-auto"
          >
